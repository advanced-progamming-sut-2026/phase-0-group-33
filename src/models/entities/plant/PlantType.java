...
public enum PlantType {
        ...
        SUN_SHROOM(3, "Sun-shroom", PlantCategory.SUN_PRODUCER,
                        Set.of(PlantTag.SHROOM, PlantTag.WRAMP_UP, PlantTag.NIGHT), 25, 300, 0, 24, 5),
        ...
        PEASHOOTER(6, "Peashooter", PlantCategory.SHOOTER, Set.of(PlantTag.PEA), 100, 300, 20, 1.5, 5),
        REPEATER(7, "Repeater", PlantCategory.SHOOTER, Set.of(PlantTag.PEA), 200, 300, 20 * 2, 1.5, 5),
        THREEPEATER(8, "Threepeater", PlantCategory.SHOOTER, Set.of(PlantTag.PEA), 300, 300, 20, 1.5, 5),
        SNOW_PEA(9, "Snow Pea", PlantCategory.SHOOTER, Set.of(PlantTag.ICE, PlantTag.PEA), 150, 300, 20, 1.5, 5),
        ROTOBAGA(10, "Rotobaga", PlantCategory.SHOOTER, Set.of(), 150, 300, 10 * 3, 1.5, 5),
        PEA_POD(11, "Pea Pod", PlantCategory.SHOOTER, Set.of(PlantTag.PEA, PlantTag.STACK), 125, 300, 20, 1.5, 5),
        SPLIT_PEA(12, "Split Pea", PlantCategory.SHOOTER, Set.of(PlantTag.PEA), 125, 300, 20, 1.5, 5),
        CITRON(13, "Citron", PlantCategory.SHOOTER, Set.of(PlantTag.CHARGE), 350, 300, 800, 9, 5),
        CAULIPOWER(14, "Caulipower", PlantCategory.HOMING, Set.of(PlantTag.MAGIC, PlantTag.CHARGE), 250, 300, -1, 12,
                        15),
        ELECTRIC_BLUEBERRY(15, "Electric Blueberry", PlantCategory.HOMING, Set.of(PlantTag.CHARGE), 150, 300, 5000, 12,
                        15),
        BOWLING_BULB(16, "Bowling Bulb", PlantCategory.SHOOTER, Set.of(PlantTag.CHARGE), 200, 300, 40, 2, 5),
        CACTUS(17, "Cactus", PlantCategory.STRIKE_THROUGH, Set.of(), 175, 300, 30, 1.5, 5),
        FIRE_PEASHOOTER(18, "Fire Peashooter", PlantCategory.SHOOTER,
                        Set.of(PlantTag.FIRE, PlantTag.PEA), 175, 300, 40, 1.5, 5),
        STARFRUIT(19, "Starfruit", PlantCategory.SHOOTER, Set.of(), 150, 300, 20, 1.5, 5),
        GOO_PEASHOOTER(20, "Goo Peashooter", PlantCategory.SHOOTER, Set.of(PlantTag.POISON), 125, 300, 20, 1.5, 5),
        MEGA_GATLING_PEA(21, "Mega Gatling Pea", PlantCategory.SHOOTER, Set.of(PlantTag.PEA), 400, 300, 20 * 4, 1.5, 5),
        SEA_SHROOM(22, "Sea-shroom", PlantCategory.SHOOTER, Set.of(PlantTag.SHROOM, PlantTag.WATER), 0, 300, 20, 1.5, 15),
        PUFF_SHROOM(23, "Puff-shroom", PlantCategory.SHOOTER, Set.of(PlantTag.SHROOM), 0, 300, 20, 1.5, 5),
        FUME_SHROOM(24, "Fume-shroom", PlantCategory.STRIKE_THROUGH, Set.of(PlantTag.SHROOM), 125, 300, 20, 1.5, 5),
        CABBAGE_PULT(25, "Cabbage-pult", PlantCategory.LOBBER, Set.of(), 100, 300, 40, 2.9, 5),
        KERNEL_PULT(26, "Kernel-pult", PlantCategory.LOBBER, Set.of(), 100, 300, 20, 2.9, 5),
        MELON_PULT(27, "Melon-pult", PlantCategory.LOBBER, Set.of(PlantTag.AOE), 325, 300, 80, 2.9, 5),
        WINTER_MELON(28, "Winter Melon", PlantCategory.LOBBER, Set.of(PlantTag.ICE, PlantTag.AOE), 500, 300, 80, 2.9, 5),
        PEPPER_PULT(29, "Pepper-pult", PlantCategory.LOBBER, Set.of(PlantTag.FIRE, PlantTag.AOE), 200, 300, 50, 2.9, 5),
        POTATO_MINE(30, "Potato Mine", PlantCategory.EXPLOSIVE,
                        Set.of(PlantTag.TRAP, PlantTag.CHARGE), 25, 300, 1800, -1, 25),
        PRIMAL_POTATO_MINE(31, "Primal Potato Mine", PlantCategory.EXPLOSIVE,
                        Set.of(PlantTag.TRAP, PlantTag.CHARGE), 50, 300, 2400, -1, 5),
        ...
        TANGLE_KELP(37, "Tangle Kelp", PlantCategory.EXPLOSIVE, Set.of(PlantTag.TRAP, PlantTag.WATER), 25, 300, -1, -1,
                        15),
        ICEBERG_LETTUCE(38, "Iceberg Lettuce", PlantCategory.EXPLOSIVE,
                        Set.of(PlantTag.TRAP, PlantTag.ICE), 0, 300, 0, -1, 20),
        BONK_CHOY(39, "Bonk Choy", PlantCategory.MELEE, Set.of(), 150, 300, 15, 0.25, 5),
        ...
        MAGNET_SHROOM(53, "Magnet-shroom", PlantCategory.HOMING,
                        Set.of(PlantTag.SHROOM, PlantTag.MAGIC), 100, 300, 0, 10, 15),
        HYPNO_SHROOM(54, "Hypno-shroom", PlantCategory.MODIFIER,
                        Set.of(PlantTag.SHROOM, PlantTag.MAGIC), 125, 300, 0, -1, 20),
        CAT_TAIL(55, "Cat-tail", PlantCategory.HOMING, Set.of(), 175, 300, 15, 1.5, 20),
